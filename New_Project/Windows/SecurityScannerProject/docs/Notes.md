...
## Registry Keys
    ...
    The Scanner: 
        The Python script acts as a viewer for that specific registry folder.

    Removal: 
        By using winreg.DeleteValue, the script "uninstalls" the instruction that tells Windows to open the spyware. 
...
## How to Spot "Real" Spyware
    ...
    When you run your scanner, look for these "Red Flags":

    Random Names: 
        Files like ax88jql.exe or svchost_updater.exe (malware often mimics real Windows files).

    Suspicious Folders:
         Anything running out of C:\Users\omega\AppData\Local\Temp or C:\Windows\Temp. Legitimate programs rarely stay in Temp folders.
